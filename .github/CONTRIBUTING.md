...
Help us keep vue-typescript-admin-template open and inclusive. Please read and follow the [Code of Conduct](https://github.com/terry-ice/blog-admin.git/blob/master/.github/CODE_OF_CONDUCT.md).

## Found a Bug

If you find a bug in the source code, you can help us by [submitting an issue](#submitting-an-issue) to our [GitHub Repository](https://github.com/terry-ice/blog-admin.git). Even better, you can [submit a Pull Request](#submitting-a-pull-request) with a fix.
...
You can file new issues by filling out the [new issue form](https://github.com/terry-ice/blog-admin.git/issues/new).

### Submitting a Pull Request

Before you submit your Pull Request (PR) consider the following guidelines:

1. Search [GitHub](https://github.com/terry-ice/blog-admin.git/pulls) for an open or closed PR that relates to your submission. You don't want to duplicate effort.
...
Please read and follow the [Commit Message Format](https://github.com/terry-ice/blog-admin.git/blob/master/.github/COMMIT_CONVENTION.md).
